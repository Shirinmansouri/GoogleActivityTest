        ...
        spCities?.onItemSelectedListener = object : AdapterView.OnItemSelectedListener{
            ...
            override fun onItemSelected(parent: AdapterView<*>?, view: View?, position: Int, id: Long) {
                when(position)
                {
                    ...
                    2 -> {
                        place1 = LatLng(40.74086502396428, -74.00874221962006)
                        place2= LatLng(40.781034751402764, -73.96755122331288)
                        place3= LatLng(40.633585983012786, -73.95223509475834)
                        place4=LatLng(40.745956476754735, -74.17139485503111)
                        place5=LatLng(40.853327959528876, -73.87692613081053)
                        loadFragment(TorontoMapsFragment())
                    }
                    3 -> {
                        place1 = LatLng(51.45003694684787, 7.004779330189205)
                        place2= LatLng(51.490929898583374, 7.04389845992266)
                        place3= LatLng(51.43968681269753, 6.806211651108742)
                        place4=LatLng(51.460809500622915, 7.000758834980649)
                        place5=LatLng(51.41479480539004, 7.009556476882874)
                        loadFragment(TorontoMapsFragment())
                    }
                    4 -> {
                        place1 = LatLng(51.50622078425671, -0.12421192748611999)
                        place2= LatLng(51.49110588637827, -0.28921920027077436)
                        place3= LatLng(51.52366729738392, -0.12769731404300835)
                        place4=LatLng(51.48069150408709, -0.15930412363876092)
                        place5=LatLng(51.52425568502064, -0.15434684994062953)
                        loadFragment(TorontoMapsFragment())
                    }
                    5 -> {
                        place1 = LatLng(40.39540948538992, -3.6979339058477287)
                        place2= LatLng(40.442732994403876, -3.638321130814093)
                        place3= LatLng(40.45168806699517, -3.730172563481489)
                        place4=LatLng(40.520173777336844, -3.655435050044181)
                        place5=LatLng(40.37928273020298, -3.6123548032656796)
                        loadFragment(TorontoMapsFragment())
                    }
                }
            }
